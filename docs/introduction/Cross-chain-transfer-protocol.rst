...
To perform this request on the sidechain side should be generated nullifier and Ceased Sidechain Withdrawal proof. Nullifier can be generated by api command nullifier(csw api gropu). Proof generation can be done with generateCswProof command.
